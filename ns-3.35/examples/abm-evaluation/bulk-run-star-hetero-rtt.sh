...
for B in 10 15 20 25 30 35 40 45; do
    ...
    for M in {1..5}; do
        ...
        for seed in {1..11}; do
            ...
            FLOWFILE="$DUMP_DIR/fcts-hetero-rtt-$BUFFER-$MINBURSTSIZE-$FSMODELONGRTT-$FSMODESHORTRTT-$seed.fct"
            TORFILE="$DUMP_DIR/tor-hetero-rtt-$BUFFER-$MINBURSTSIZE-$FSMODELONGRTT-$FSMODESHORTRTT-$seed.stat"
            PARAMFILE="$DUMP_DIR/param-hetero-rtt-$BUFFER-$MINBURSTSIZE-$FSMODELONGRTT-$FSMODESHORTRTT-$seed.txt"
