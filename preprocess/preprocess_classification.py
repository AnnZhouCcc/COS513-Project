...
for data_cca_index, data_cca in enumerate(data_cca_arr):
    ...
    train_data_path = output_data_path_prefix + "X_classification_train.csv"
    target_data_path = output_data_path_prefix + "y_classification_train.csv"
    test_data_path = output_data_path_prefix + "X_classification_test.csv"
    ytest_data_path = output_data_path_prefix + "y_classification_test.csv"
    ...
    for i in range(num_pieces):
        ...
        piece['series_id'] = data_cca_index*num_pieces*2+i
    ...
    for i in range(num_pieces):
        ...
        piece['series_id'] = data_cca_index*num_pieces*2+i+num_pieces
        piece['timestamp'] = np.arange(sequence_length)
        df_train_list.append(piece)
    ...
    for i in range(num_test_pieces):
        ...
        piece['series_id'] = data_cca_index*num_test_pieces*2+i
        piece['timestamp'] = np.arange(sequence_length)
    ...
    for i in range(num_test_pieces):
        ...
        piece['series_id'] = data_cca_index*num_test_pieces*2+i+num_test_pieces
        piece['timestamp'] = np.arange(sequence_length)
        df_test_list.append(piece)
...
data_y_train['series_id'] = np.arange(len(data_cca_arr)*num_train_pieces*2)
data_y_train['cca_id'] = 0 # CUBIC
data_y_train.iloc[num_train_pieces*2:,1] = 1 # Timely
...
data_y_test['series_id'] = np.arange(len(data_cca_arr)*num_test_pieces*2)
data_y_test['cca_id'] = 0 # CUBIC
data_y_test.iloc[num_test_pieces*2:,1] = 1 # Timely
