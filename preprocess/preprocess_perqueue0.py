...
for data_cca_index, data_cca in enumerate(data_cca_arr):
    ...
    train_data_path = output_data_path_prefix + "X_perqueue0_train.csv"
    target_data_path = output_data_path_prefix + "y_perqueue0_train.csv"
    test_data_path = output_data_path_prefix + "X_perqueue0_test.csv"
    ytest_data_path = output_data_path_prefix + "y_perqueue0_test.csv"
    ...
    for q in range(0,num_ports*2,2):
...
total_train_len = len(data_cca_arr)*num_train_pieces*2*num_ports
...
total_test_len = len(data_cca_arr)*num_test_pieces*2*num_ports
